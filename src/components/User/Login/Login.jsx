                    ...
                    <div className={styles.inputcontainer}>
                        <div>
                            ...
                            <GoogleLogin
                                ...
                                render={(renderProps) => (
                                    <button className={styles.loginbutton} onClick={renderProps.onClick} disabled={renderProps.disabled}>
                                      {/* <img src='/images/google.svg' className={styles.googleimg} alt='Google' /> */}
                                      <span className={styles.heading}>SignIn with Google</span>
                                    </button>)}
                                
                            />
                                <p className={styles.terms}>By continuing, I agree to the <span className={styles.conditions}>Terms of Use</span> & <span className={styles.conditions}>Privacy Policy</span></p>                                 <p>Have trouble in logging in? <span className={styles.conditions}>Get help</span></p>
                             </div>
                        </div>
